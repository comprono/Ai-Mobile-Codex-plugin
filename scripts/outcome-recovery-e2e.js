...
function makeWorkspace(name) {
  ...
  fs.writeFileSync(path.join(workspace, ".codex", "PROJECT_OUTCOME.md"), [
    ...
    "## North Star",
    "",
    "- Outcome: Restore verified application throughput with truthful, unique, canonically confirmed results.",
    "- Why it matters: The project must produce real verified results.",
    "",
    "## User Intent",
    "",
