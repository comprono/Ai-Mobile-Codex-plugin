...
assert.equal(handoff.expectedRuntimeVersion, "1.2.1");
...
assert.match(handoff.resumePrompt, /Invoke run-task-cycle exactly once/i);
...
assert.equal(dry.ExpectedRuntimeVersion, "1.2.1");
