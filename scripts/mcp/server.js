...
const WORK_UNIT_SCHEMA = {
  ...
  properties: {
    ...
    requiredCapabilities: { type: "array", maxItems: 12, items: { type: "string" }, description: "Callable capabilities required by this lane, such as source, local-files, git, tests, browser, github, api, or project-tools." },
  },
};
