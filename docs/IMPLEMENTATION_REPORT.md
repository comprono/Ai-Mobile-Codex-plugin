...
Status: lean runtime implemented in v0.5.0; finite first-call correction implemented in v0.5.1; stale-task protection implemented in v0.5.2; turn-exit and capacity correction implemented in v0.5.3; comparative real-project measurement remains ongoing
Research baseline: 2026-07-14
Current target: `0.5.3`
